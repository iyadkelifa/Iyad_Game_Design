...
LEV_I=False
#List f messages
MenuList=['Instructions','Settings', " Level 1","Level 2",'Level 3','Level 4','Level 5']
...
while check:
    ...
    if case.type ==pygame.MOUSEBUTTONDOWN:
        ...
        if ((mouse_pos[0] >20 and mouse_pos[0] <80) and (mouse_pos[1] >250 and mouse_pos[1] <290))or INST :
            ...
            if keys[pygame.K_x]:
                MAIN=True
        elif ((mouse_pos[0] >20 and mouse_pos[0] <80) and (mouse_pos[1] >300 and mouse_pos[1] <330))or SETT :
            MAIN=False
            screen.fill(background)
            TitleMenu("SETTINGS")
            ...
            if keys[pygame.K_x]:
                MAIN=True
        elif ((mouse_pos[0] >20 and mouse_pos[0] <80) and (mouse_pos[1] >350 and mouse_pos[1] <380))or LEV_I :
            MAIN=False
            screen.fill(background)
            TitleMenu("Level 1")
            LEV_I=True
