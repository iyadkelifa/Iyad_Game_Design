...
#load images
sun_pic = pygame.image.load('images/sun.png')
sun_pic = pygame.transform.scale(sun_pic, (tile_size, tile_size))
bg_pic = pygame.image.load('images/sky.png')
bg_pic = pygame.transform.scale(bg_pic, (screen_width, screen_height - margin))
dirt_img = pygame.image.load('images/dirt.png')
grass_img = pygame.image.load('images/grass.png')
blob_img = pygame.image.load('images/blob1.png')
platform_x_img = pygame.image.load('images/platform_x.png')
platform_y_img = pygame.image.load('images/platform_y.png')
lava_img = pygame.image.load('images/water.png')
...
while run:
	...
	screen.blit(sun_pic, (tile_size * 2, tile_size * 2))
